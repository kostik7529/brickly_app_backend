...
public interface PartQueryRepository {
    ...
    @Query(value = """
            ...
            countQuery = """
                    ...
                    """,
            nativeQuery = true)
    Page<PartFromItemDTO> findPartsBySetId(@Param("itemId") String itemId, Pageable pageable);
    ...
    @Query(value = """
            ...
            countQuery = """
                    ...
                    """,
            nativeQuery = true)
    Page<PartFromItemDTO> findPartsByMinifigId(@Param("minifigId") String minifigId, Pageable pageable);
}
